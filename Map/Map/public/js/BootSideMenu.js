(function ($) {
    ...
    $.fn.BootSideMenu = function (options) {
        ...
        newCode += "<div class=\"container\" style=\"width: 380px;\" data-side=\"" + side + "\">\n" + oldCode + " </div>\n";
        newCode += "<div class=\"toggler\">\n";
        //newCode += "	<span class=\"fa fa-2x fa-angle-right\">&nbsp;</span> <span class=\"fa fa-2x fa-angle-left\">&nbsp;</span>\n";
        newCode += "	<span class=\"fa fa-2x fa-bars\">\n";
        newCode += "</div>\n";
    ...
    function toggleArrow(toggler, side) {
        if (side == "left") {
            ...
            $(toggler).children(".fa-angle-left").css('display', 'block');
